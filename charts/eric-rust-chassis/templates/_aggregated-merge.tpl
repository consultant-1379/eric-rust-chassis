...
*/ -}}
{{- define "eric-rust-chassis.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-rust-chassis.mergeAnnotations" -}}
  {{- include "eric-rust-chassis.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-rust-chassis.mergeLabels" -}}
  {{- include "eric-rust-chassis.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
